...
//              calendarHeaderHtml+=    "</div>";
  ...
  TODO    if total height for an hour is less than 11px, there is a display problem.
      ...
      _renderEvent: function(calEvent, $weekDay) {
          ...
          eventHtml += '<div class=\"wc-time ui-corner-top\"><a data-fancybox data-type="iframe" data-src="../grupos/Horario" href="javascript:;">Info</a></div>';
          eventHtml += '<div class=\"wc-title\"></div>';
          //*********************************DIV NEW TITLE ENCONTRAR1 <a data-fancybox data-type="iframe" data-src="http://codepen.io/fancyapps/full/jyEGGG/" href="../grupos/Horario">Info</a></div>**<a data-fancybox data-type="iframe" data-src="../grupos/Horario" href="javascript:;">Info</a>
          //</div><div class="embed-container"><iframe src="../grupos/Horario" frameborder="0" allowfullscreen></iframe></div></div>**<a class="various fancybox.iframe" href="../grupos/Horario">Info</a>
